...
OUT="$REPO/ns3/results/adaptive_mining_compare"
RUNS="$OUT/runs"
mkdir -p "$RUNS"
...
make_trace () {
  ...
  local RUN_DIR="$REPO/sumo/output/adapt_mining/${TAG}"
